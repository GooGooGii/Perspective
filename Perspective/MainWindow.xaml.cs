...
namespace Perspective
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow(string args)
        {
            ...
            ArgInput = args;
            vm.path = @Directory.GetParent(@args).FullName; ;
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                vm.ThumbnailPath = string.Concat(@"D:\SeanWu\Repository\Perspective\Perspective\Perspective\bin\Debug", @"\Thumbnail");
                //MessageBox.Show(vm.ThumbnailPath);
            }
            ...
            //System.Windows.MessageBox.Show(vm.list_DirDataModels.Count.ToString());
